...
"Given a scientific claim, carefully analyze its factual accuracy. Consider key factors like the claim's central assertion, relevant scientific context, existing literature, potential supporting or conflicting evidence, and any critical limitations. Based on this analysis, create a structured outline to guide a clear, evidence-supported verification response. Specify the sections and the proportion each should contribute to the final response, totaling 100%. The outline will clarify the scope, evidence required, and emphasis of each part."
"Your outline should be marked as [Response_Start] Answer [Response_End]."
"Here's an example outline:"
"Claim: Quadrotor UAVs can safely operate in extreme weather conditions without specialized modifications."
"Answer: [Response_Start]"
"1. (20%) Clearly restate the claim and explicitly provide a judgment in the form of 'Judgment: True.\n' or 'Judgment: False.\n'."
"2. (50%) Present key supporting or contradicting evidence, explaining how it justifies the judgment."
"3. (30%) Summarize critical considerations, nuances, or remaining uncertainties, and reinforce the final judgment."
"[Response_End]"
"Now, please create an outline for this claim: {question}"
)


initial_generation_w_references_zero_shot = (
"Provide a detailed verification of the following scientific claim. Structure your response clearly according to the outline below, with each section proportionate to the outline's recommended percentage. Each section must be backed by multiple scientific references, clearly cited."
"Start by clearly stating your judgment in the format 'Judgment: True.\n' or 'Judgment: False.\n'."
...
"\nClaim: {input}"
"\nOutline: {outline}"
"Your answer should clearly state whether the claim is true or false and provide strong supporting evidence."
