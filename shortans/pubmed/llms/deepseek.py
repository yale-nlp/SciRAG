...
DEEPSEEK_API_KEY = config.get("DEEPSEEK_API_KEY", "your-deepseek-api-key")

class DeepSeek(LanguageModel):
    def __init__(
        self, model: str = "deepseek-reasoner", api_key: str = None, *args, **kwargs
    ):
...
if __name__ == "__main__":
    client = DeepSeek(model="deepseek-reasoner")
    print(client.chat("Hello, who are you?", json_mode=True))
